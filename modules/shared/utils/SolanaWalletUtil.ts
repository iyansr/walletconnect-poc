import SolanaLib from '@modules/shared/lib/SolanaLib';
...
export async function createOrRestoreSolanaWallet() {
  const secretKey1 = await AsyncStorage.getItem('SOLANA_SECRET_KEY_1');
  const secretKey2 = await AsyncStorage.getItem('SOLANA_SECRET_KEY_2');
